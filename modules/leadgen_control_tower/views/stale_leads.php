...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <h4><?php echo _l('leadgen_control_tower_stale_leads'); ?></h4>
                <hr class="hr-panel-heading" />

                <p class="text-muted"><?php echo sprintf($this->lang->line('leadgen_control_tower_sla_threshold_note'), (int) $threshold_minutes); ?></p>
                <p class="text-muted"><?php echo _l('leadgen_control_tower_stale_leads_note'); ?></p>

                <?php if (empty($leads)) { ?>
                    <div class="alert alert-info"><?php echo _l('leadgen_control_tower_stale_leads_none'); ?></div>
                <?php } else { ?>
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo _l('leadgen_control_tower_col_stale_since'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-muted">
                                <?php echo html_escape(_dt($row['stale_since'])); ?>
                                (<?php echo (int) $row['minutes_stale']; ?> min)
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
