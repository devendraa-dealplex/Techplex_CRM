...
$admin = is_admin();
$badge = ['Present' => 'success', 'Late' => 'warning', 'Working' => 'info', 'Incomplete' => 'warning', 'Absent' => 'danger', 'Pending' => 'default'];
$thumb = function ($id) {
    if (!$id) {
...
<div id="wrapper"><div class="content">
    <h4 class="tw-font-semibold tw-mb-3"><?= $self ? 'My Attendance' : 'Attendance Dashboard'; ?></h4>
    <?php $this->load->view('attendance_dashboard/_filters', ['f' => $f, 'workplaces' => $workplaces, 'showStatus' => true, 'showText' => !$self, 'showLocation' => !$self,
        'statusOptions' => ['' => 'All', 'present' => 'Present', 'late' => 'Late', 'working' => 'Working', 'incomplete' => 'Incomplete', 'absent' => 'Absent']]); ?>
    ...
    <?php foreach ([
        ...
        <div class="col-md-2 col-sm-4 col-xs-6" style="width:16.66%;min-width:140px">
